...
from NoteNinja.modules.nightmode import button_row
from NoteNinja import BOT_USERNAME, OWNER_ID,BOT_NAME, SUPPORT_CHAT, telethn
from NoteNinja.events import register
...
async def lego(event):
    ...
    try:
        ...
        fnt = glob.glob("./NoteNinja/resources/fonts/*")
