...
from NoteNinja import  MONGO_DB_URI

mongo = MongoCli(MONGO_DB_URI)
NoteNinjadb = mongo.MUK_ROB

try:
    client = MongoClient(MONGO_DB_URI)
except PyMongoError:
    exiter(1)
main_db = client["NoteNinja_ROBOT"]


NoteNinjaXdb = main_db


def get_collection(name: str) -> collection:
    """ɢᴇᴛ ᴛʜᴇ ᴄᴏʟʟᴇᴄᴛɪᴏɴ ғʀᴏᴍ ᴅᴀᴛᴀʙᴀsᴇ."""
    return NoteNinjaXdb[name]
...
class MongoDB:
    ...
    def __init__(self, collection) -> None:
        self.collection = NoteNinjaXdb[collection]
