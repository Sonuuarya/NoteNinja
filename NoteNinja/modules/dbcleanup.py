...
import NoteNinja.modules.sql.global_bans_sql as gban_sql
import NoteNinja.modules.sql.users_sql as user_sql
from NoteNinja import DEV_USERS, OWNER_ID, dispatcher
