...
from NoteNinja import OWNER_ID, pbot
from NoteNinja.utils.admins import can_change_info
from NoteNinja.utils.errors import capture_err
from NoteNinja.utils.mongo import (
    alpha_to_int,
    get_karma,
    get_karmas,
    int_to_alpha,
...
regex_upvote =r"^(\+|\+\+|\+1|thx|thanx|thanks|🖤|❣️|💝|💖|💕|❤️|💘|cool|good|\👍|baby|NoteNinja|thank you|gud|thankyou|love|pro)$"
