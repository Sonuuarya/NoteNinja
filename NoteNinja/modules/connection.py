...
import NoteNinja.modules.sql.connection_sql as sql
from NoteNinja import DEV_USERS, DRAGONS, dispatcher
from NoteNinja.modules.helper_funcs import chat_status
