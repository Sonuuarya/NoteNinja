...
@NoteNinja.on_message(filters.command(["gps"]))
...
#     await message.delete()
    ...
    try:
        ...
        ---------telegram : @Sonuuarya-----
        """
        geolocator = Nominatim(user_agent="legend-NoteNinja")
#         zoom=[0-18]
...
@NoteNinja.on_message(filters.command(["distance"]))
...
# NoteNinja.add_handler(MessageHandler(gps))     
# NoteNinja.add_handler(MessageHandler(distance))
