...
# from NoteNinja.modules.sql import warns_sql as warnssql
import NoteNinja.modules.sql.blacklist_sql as blacklistsql

# from NoteNinja.modules.sql import cust_filters_sql as filtersql
# import NoteNinja.modules.sql.welcome_sql as welcsql
import NoteNinja.modules.sql.locks_sql as locksql
import NoteNinja.modules.sql.notes_sql as sql

# from NoteNinja.modules.rules import get_rules
import NoteNinja.modules.sql.rules_sql as rulessql
from NoteNinja import EVENT_LOGS,OWNER_ID, SUPPORT_CHAT, dispatcher
from NoteNinja.__main__ import DATA_IMPORT
from NoteNinja.modules.connection import connected
from NoteNinja.modules.helper_funcs.alternate import typing_action
from NoteNinja.modules.helper_funcs.chat_status import user_admin
from NoteNinja.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("NoteNinja{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("NoteNinja{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `NoteNinja-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("NoteNinja{}.backup".format(chat_id))  # Cleaning file
