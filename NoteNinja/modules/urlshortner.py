...
@NoteNinja.on_message(filters.command(["short"]))
...
@NoteNinja.on_message(filters.command(["unshort"]))
...
# NoteNinja.add_handler(MessageHandler(short_urls))
# NoteNinja.add_handler(MessageHandler(unshort))
__help__ = """
