...
if ENV:
    ...
    from NoteNinja.config import Development as Config
...
telethn = TelegramClient("NoteNinja", API_ID, API_HASH)

pbot = Client("NoteNinja", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN,in_memory=True)
...
from NoteNinja.modules.helper_funcs.handlers import (
